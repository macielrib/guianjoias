...
const OfertasImperdiveis: React.FC = () => {
  return (
    <section className="bg-black py-16 flex flex-col md:flex-row items-center justify-center px-6">
      
      <div className="w-full md:w-1/2 flex justify-center md:justify-end md:mr-12 transition duration-300 hover:scale-105">
        <Image
