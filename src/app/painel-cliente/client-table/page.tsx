...
const ClientTable = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto lg:mx-0">
      {/* Header */}
      <div className="grid grid-cols-1 sm:grid-cols-5 gap-4 text-center p-4 text-[#DCC373] font-normal font-poppins text-md md:text-lg bg-transparent">
        ...
        >
          ...
          <div className="relative pl-6 items-center text-center sm:col-span-1">
            <Tooltip text={product.name}>
              <span className="md:truncate max-w-full sm:max-w-[40px] md:max-w-[120px] lg:max-w-[140px] text-[#FBF7C6] font-poppins font-normal block">
                {product.name}
              </span>
            </Tooltip>
          </div>
      ...
      <AnimatePresence>
        {selectedOrder && (
          <motion.div
            ...
            animate={{ opacity: 1 }} // Opacidade ao abrir
            exit={{ opacity: 0 }} // Opacidade ao fechar
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1 }} // Escala ao abrir
              exit={{ scale: 0.8 }} // Escala ao fechar
              transition={{ duration: 0.3 }} // Duração da transição
            >
