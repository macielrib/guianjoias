          ...
          <div className="flex flex-col">
            <div className="relative mt-2 flex flex-col mb-2">
              ...
              <input
                ...
                className="border-2 !border-[#4F4F4F] bg-transparent rounded-lg py-4 px-3 pl-8 text-[#4F4F4F] placeholder:text-[#4F4F4F] font-poppins font-normal text-sm w-[350px] md:w-[477px] h-[48px] focus:border-[#F2DD52] focus:outline-none transition duration-300"
                maxLength={50}
              />
            </div>
            <div className="relative mt-2 flex flex-col mb-2">
