...
const AdminTable = () => {
  ...
  return (
    <div className="w-full max-w-[900px] lg:max-w-[1280px] xl:max-w-[980px] mx-auto lg:ml-4 mt-8">
      {/* Header */}
      ...
      <AnimatePresence>
        {selectedOrder && (
          ...
          >
            <motion.div
              className="bg-[#171717] border border-[#4F4F4F] text-white w-[90%] max-w-lg max-h-[90%] p-6 rounded-xl relative animate-fadeIn overflow-y-auto scrollbar-hidden"
            ...
            >
              ...
              <div className="flex items-end gap-2 mb-6">
                ...
                <p className="font-poppins text-sm font-normal text-[#4F4F4F]">
                  Ao inserir o código de rastreio, ele será enviado diretamente
                  ao cliente, verifique oeste dado com cuidado.
                </p>
              </div>
