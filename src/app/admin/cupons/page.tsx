  ...
  return (
    <>
      <div className="flex flex-col -mt-8  items-center w-full">
        <div className="bg-[#F2DD52] hidden lg:block rounded-md w-full max-w-6xl md:w-[70rem] h-4 md:ml-16 mt-4"></div>
        <div className="w-full max-w-5xl bg-transparent text-center lg:text-start py-2 rounded-lg mt-4 flex flex-col md:flex-row items-center gap-3 justify-center lg:justify-start">
        ...
        <div className="w-full max-w-5xl  mt-4  text-center lg:text-start">
      ...
      <div className="flex flex-col w-full max-w-6xl mx-auto gap-6 text-center px-10 md:px-0 md:text-center lg:text-start items-start justify-start">
        {/* Texto "3 cupons registrados." */}
        <div className="w-full md:ml-20 mb-2">
          <p className="font-poppins text-white text-md font-normal">
        ...
        <div className="flex flex-col lg:flex-row w-full  gap-6 items-center md:items-center justify-start">
          ...
          {/* Cupons Ativos */}
          <div className="w-full max-w-5xl md:ml-4 mx-auto mt-8">
